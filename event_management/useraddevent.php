...
<body>
  <center>
    ...
    <form action="insert.php" method="POST" style="margin-top:-100px">
        <div class="addstyle">
          <h1>Create/Add Event</h1>
        <input type ="hidden" name="Event_ID" type="text" />
        <label for="Name">Name:</label><input type ="text" name="Name"/>
        <label for="Type">Type:</label><input type ="text" name="Type"/></br>
        <label for="Theme">Theme:</label><input type ="text" name="Theme"/>
        ...
        <label for="Time">Time:</label><input type ="text" name="Time"/>
        <label for="No_of_Attendees">No. of attendees:</label><input type ="text" name="No_of_Attendees" /></br>
        <label for="catery">Catery:</label><input type ="text" name="catery"/>
        <label for="clothing_vendor">Clothing:</label><input type ="text" name="clothing_vendor"/></br>
        <label for="photography_and_video">Photography:</label><input type ="text" name="photography_and_video"/>
        <label for="car_rental">Car rental:</label><input type ="text" name="car_rental" /></br>
        <label for="event_designer">Event designer:</label><input type ="text" name="event_designer""/>
        <label for="invitations_and_printing">Invitations:</label><input type ="text" name="invitations_and_printing"/></br>
        <label for="music" style="margin-left: -43.8%">Music:</label><input type ="text" name="music" style="margin-left: -33.3%" />
        <input type="hidden" type ="text" name="status"/></br>

        <div></div><input type="submit" name="save" value="Save">
        </div>
        
      
    </form>
    <a href="usermenu.php"><div class="btnstyle2"><input  type="submit" name="login" value="back"/></div></a>
  </center>
</body>
</html>
<div class="divide">

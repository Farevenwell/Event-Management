  ...
  <link rel="stylesheet" href="menustyle.css">
    <div class="menu-style">
        <form action="" method="POST">
            <a href="addevent.php"><input type="button" name="book" value="Book Event"></a>
            <a href="searchevent.php"><input type="button" name="search" value="Event Search"></a>
            <a href="updateevent.php"><input type="button" name="manage" value="Update Event"></a>
            <a href="deletevent.php"><input type="button" name="delete" value="Delete Event"></a>
            <div></div>
            <a href="viewcustomers.php"><input type="button" name="customer" value="View All Customers"></a>
            <a href="viewevent.php"><input type="button" name="viewall" value="View All Events"></a>
            <a href="viewsuppliers.php"><input type="button" name="suppliers" value="View All Suppliers"></a>

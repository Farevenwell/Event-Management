...
<body>
 <center>
    <form action="" method="POST" style="margin-top:-100px">
      <h1>Delete Event</h></br>
      <input type="text" style="margin-left: 8%" name="Event_ID" placeholder="Enter Event ID" required /> </br>
      <input type="submit" style="margin-left: 8%" name="delete" value="Delete"/>
    </form>

  </center>
  <a href="Menu.php">
<div class="btnstyle" style="margin-left: 3.5%"><input  type="submit" name="back" value="back"/></div></a>
  ...
  if(isset($_POST['delete']))
{
  ...
  if($query_run)
     ...
     {
      echo '<script> alert("Event doesnt exist.") </script>';
     }
}

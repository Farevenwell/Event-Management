...
<body>
  ...
  <center>
    <form action=""method="POST" style="margin-top:-100px">
      ...
      <div ><input type="text" name="Event_ID" placeholder="Enter Event ID" required /></div>
...
$database = mysqli_select_db($connection, 'Event_management');
  if(isset($_POST['search']))
  {
    ...
    while ( $row = mysqli_fetch_array($query_run)) 
    {
      ...
      <a href="searchevent.php"><div class="btnstyle"><input type="submit" name="Back" value="back"></div></a>
    </div>
    <?php
    }
  }

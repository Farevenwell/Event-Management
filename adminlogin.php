  ...
  <link rel="stylesheet" href="adminloginstyle.css">
    <div class="contact-form">
       <img src="1.png" class="avatar">
        <h2> Sign-in as</br> Event Organizer</h2>
        <form action="" method="POST">
            <p>Email</p>
            <input type="text" name="email" class="txtbox" placeholder="Enter Email" required>
            <p>Password</p>
            <input type="password" name="password" class="txtbox" placeholder="Enter Password" required>
...
if(isset($_POST['login']))
{
    ...
    $query = "SELECT * FROM `event_organizer` WHERE email='$email' AND password = '$password'";

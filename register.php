...
<body>
  <link rel="stylesheet" href="registerstyle.css">
    ...
    <form action = "" method="POST" >
      ...
      <input id = "first_name" type="text" name="first_name" class="txtbox" placeholder="Enter first name" required></br>
      <input id = "last_name" type="text" name="last_name" class="txtbox" placeholder="Enter last name" required></br>
      <input id="address" type="text" name="address" class="txtbox" placeholder="Enter address" required></br>
      <input id="contact_no" type="text" name="contact_no" class="txtbox" placeholder="Enter contact no" required></br>
      <input id="email" type="email" name="email" class="txtbox" placeholder="Enter email" required></br>
      <input id="password" type="password" name="password" class="txtbox" placeholder="Enter password" required></br>
      <input id="cpassword" type="password" name="cpassword" class="txtbox" placeholder="Confirm password" required></br></br></br>

      <input  type="submit" name="login" class="btn" value="Create Account"/></a> 

    </form>
    
  </div>
    <div class="motto">
  <h1>" A site that delivers the events that you dream of "</h1>
  </div>
...
<?php
    ...
    $random =  100 . $randomnum;

      if ($password==$cpassword)
      {

            $query = "SELECT * FROM cstmr_signup WHERE email='$email'";
            ...
            {
        $query = "INSERT INTO `cstmr_signup` (`customer_ID`,`first_name`, `last_name`,`address`,`contact_no`,`email`, `password`, `cpassword`) VALUES 
        ('$random','$first_name','$last_name','$address','$contact_no','$email','$password','$cpassword')";

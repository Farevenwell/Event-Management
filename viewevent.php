...
<body>
  ...
  <th>Catery</th>
  <th>Clothing Vendor</th>
  <th>Photograhy and Video</th>
  <th>Car Rental</th>
  <th>Event Design</th>
  <th>Invitations and Printing</th>
  <th>Music</th>
  <th>Status</th>
...
$sql = "SELECT Event_ID, Name, Type, Theme, Venue, Date, Duration, Time, No_of_Attendees, catery, clothing_vendor,photography_and_video,car_rental, event_designer, invitations_and_printing, music, status  FROM event";
...
if($result->num_rows > 0){
  ...
  .$row["Duration"]."</td><td>"
  .$row["Time"]."</td><td>"
  .$row["No_of_Attendees"]."</td><td>"
  .$row["catery"]."</td><td>"
  .$row["clothing_vendor"]."</td><td>"
  .$row["photography_and_video"]."</td><td>"
  .$row["car_rental"]."</td><td>"
  .$row["event_designer"]."</td><td>"
  .$row["invitations_and_printing"]."</td><td>"
  .$row["music"]."</td><td>"
  .$row["status"].
   "</td></tr>";
  }
...
<a href="Menu.php">
<div class="btnstyle"><input  type="submit" name="login" value="back"/></div></a>
